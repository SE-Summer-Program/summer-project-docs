...
alter table Appointment add constraint FK_Relationship_1 foreign key (line_id)
       references Line (line_id) on delete restrict on update restrict;
       
alter table Shift add constraint FK_Relationship_2 foreign key (line_id)
       references Line (line_id) on delete restrict on update restrict;
