...
public class AdminloginFragment extends BaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_adminlogin, container, false);
        Button login_btn = view.findViewById(R.id.btn_adminlogin);
        username_edit = view.findViewById(R.id.adminlogin_username_edit);
        password_edit = view.findViewById(R.id.adminlogin_pwd_edit);
